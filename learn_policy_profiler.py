...
import torch.autograd.profiler as profiler ## PROFILER
...
# Encapsulated the for loop "for i in range(args.runs):" with the two profiler blocks
# Added the print profiler line at very end
if __name__ == '__main__':
  ...
  print("[INFO] Printing PyTorch profiler data...")            
  print(prof.key_averages().table(sort_by="self_cuda_time_total"))
